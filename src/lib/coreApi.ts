...
export function me(): Promise<MeResult> { return requestCore<MeResult>('/api/v1/auth/me'); }
export function csrf(): Promise<{ csrf_token: string }> { return requestCore<{ csrf_token: string }>('/api/v1/auth/csrf'); }
